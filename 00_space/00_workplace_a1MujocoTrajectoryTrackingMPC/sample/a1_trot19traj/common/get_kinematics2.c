...
if (leg_no == 3)
{
  ...
  // for (i=0;i<3;i++)
  // {
  //     //vector from foot to shoulder = shoulder - foot
  //     pos_sdfast_foot2shoulder[0][i] = -pos_FR_foot_sdfast[i] + pos_FR_shoulder_sdfast[i];
  //     pos_sdfast_foot2shoulder[1][i] = -pos_FL_foot_sdfast[i] + pos_FL_shoulder_sdfast[i];
  //     pos_sdfast_foot2shoulder[2][i] = -pos_RR_foot_sdfast[i] + pos_RR_shoulder_sdfast[i];
  //     pos_sdfast_foot2shoulder[3][i] = -pos_RL_foot_sdfast[i] + pos_RL_shoulder_sdfast[i];
  //     if (i==1)
  //     {
  //       pos_sdfast_foot2shoulder[0][i] += -width_calibration;
  //       pos_sdfast_foot2shoulder[1][i] += width_calibration;
  //       pos_sdfast_foot2shoulder[2][i] += -width_calibration;
  //       pos_sdfast_foot2shoulder[3][i] += width_calibration;
  //     }
  //
  //     vel_sdfast_foot2shoulder[0][i] = -vel_FR_foot_sdfast[i] + vel_FR_shoulder_sdfast[i];
  //     vel_sdfast_foot2shoulder[1][i] = -vel_FL_foot_sdfast[i] + vel_FL_shoulder_sdfast[i];
  //     vel_sdfast_foot2shoulder[2][i] = -vel_RR_foot_sdfast[i] + vel_RR_shoulder_sdfast[i];
  //     vel_sdfast_foot2shoulder[3][i] = -vel_RL_foot_sdfast[i] + vel_RL_shoulder_sdfast[i];
  // }
}
